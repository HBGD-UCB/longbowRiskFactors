...
output: 
  html_document:
    standalone: true
    self_contained: true
required_packages:  ['knitr', 'igraph@1.0.1', 'github://tlverse/sl3', 'github://tlverse/tmle3@56400a3', 'github://jeremyrcoyle/skimr@vector_types', 'Rsolnp', 'glmnet', 'xgboost', 'randomForest', 'future', 'ck37r',
...
others <- setdiff(seq_along(estimates), baseline)
